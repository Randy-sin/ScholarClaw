...
from scholarclaw_engine.agents.base import BaseAgent, AgentStepResult
...
class CodeGenAgent(BaseAgent):
    ...
    def _generate_script(
        ...
        *,
        ...
        from scholarclaw_engine.agents.figure_agent.style_config import FIGURE_WIDTH, DEFAULT_FIGURE_HEIGHT
