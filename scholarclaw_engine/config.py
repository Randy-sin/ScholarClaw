"""ScholarClaw config loading and validation."""
...
CONFIG_SEARCH_ORDER: tuple[str, ...] = ("config.scholarclaw.yaml", "config.yaml")
EXAMPLE_CONFIG = "config.scholarclaw.example.yaml"
...
class AcpConfig:
    ...
    cwd: str = "."
    acpx_command: str = ""
    session_name: str = "scholarclaw_engine"
...
class SshRemoteConfig:
    ...
    key_path: str = ""
    gpu_ids: tuple[int, ...] = ()
    remote_workdir: str = "/tmp/scholarclaw_engine_experiments"
    remote_python: str = "python3"
    setup_commands: tuple[str, ...] = ()
    use_docker: bool = False
    docker_image: str = "scholarclaw_engine/experiment:latest"
...
class ColabDriveConfig:
    ...
    drive_root: str = ""  # local mount path, e.g. ~/Google Drive/MyDrive/scholarclaw_engine
...
class DockerSandboxConfig:
    ...
    image: str = "scholarclaw_engine/experiment:latest"
...
def _parse_llm_config(data: dict[str, Any]) -> LlmConfig:
    ...
    return LlmConfig(
        ...
        acp=AcpConfig(
            ...
            session_name=acp_data.get("session_name", "scholarclaw_engine"),
...
def _parse_experiment_config(data: dict[str, Any]) -> ExperimentConfig:
    ...
    return ExperimentConfig(
        ...
        docker=DockerSandboxConfig(
            image=docker_data.get("image", "scholarclaw_engine/experiment:latest"),
        ...
        ssh_remote=SshRemoteConfig(
            ...
            docker_image=ssh_data.get("docker_image", "scholarclaw_engine/experiment:latest"),
