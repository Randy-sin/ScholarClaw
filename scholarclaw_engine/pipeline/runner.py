...
from scholarclaw_engine.evolution import EvolutionStore, extract_lessons
from scholarclaw_engine.knowledge.base import write_stage_to_kb
from scholarclaw_engine.pipeline.executor import StageResult, execute_stage
...
def _package_deliverables(
    ...
    if (
        ...
        try:
            ...
            from scholarclaw_engine.pipeline.executor import _extract_paper_title
    ...
    try:
        from scholarclaw_engine.templates import get_template
