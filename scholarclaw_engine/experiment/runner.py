"""Experiment execution engine inspired by prior work's edit→run→eval→keep/discard loop."""
...
from scholarclaw_engine.config import ExperimentConfig, SandboxConfig, SshRemoteConfig
from scholarclaw_engine.experiment.factory import create_sandbox
from scholarclaw_engine.experiment.sandbox import SandboxProtocol
