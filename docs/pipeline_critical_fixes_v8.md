...
- **文件**: `scholarclaw_engine/templates/converter.py`
...
- **文件**: `scholarclaw_engine/templates/converter.py` + `scholarclaw_engine/prompts.py`
...
- **文件**: `scholarclaw_engine/literature/models.py`
...
- **文件**: `scholarclaw_engine/pipeline/executor.py`
...
- **修复**: `git checkout main -- scholarclaw_engine/agents/figure_agent/ scholarclaw_engine/agents/__init__.py scholarclaw_engine/agents/base.py tests/test_figure_agent.py`
- **状态**: ✅ 已修复

### T3.3 负面结果处理
- **问题**: 当方法表现不如 baseline 时，论文仍写成 positive contribution
- **文件**: `scholarclaw_engine/pipeline/executor.py` + `scholarclaw_engine/prompts.py`
...
- **文件**: `scholarclaw_engine/pipeline/stages.py`
...
- **文件**: `scholarclaw_engine/config.py`
