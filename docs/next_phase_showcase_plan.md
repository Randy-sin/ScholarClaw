# ScholarClaw — Phase 5: Showcase Website & Sample Papers
...
2. **Build a static website** to publicly present ScholarClaw's pipeline, features, and sample outputs
...
| Domain | `scholarclaw.github.io` or custom | GitHub Pages default |
...
- Free hosting on `scholarclaw.github.io`
...
1. **Custom domain?** — Do we want a custom domain (e.g., `scholarclaw.com`) or is `github.io` sufficient?
