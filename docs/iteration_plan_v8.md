# ScholarClaw Pipeline — 持续迭代改进方案 V8
...
**文件**: `scholarclaw_engine/prompts.py`, `scholarclaw_engine/pipeline/executor.py`
...
**文件**: `scholarclaw_engine/pipeline/executor.py` (新阶段)
**问题**: 代码生成后无系统性审查
...
**文件**: `scholarclaw_engine/docker/Dockerfile`
...
**文件**: `scholarclaw_engine/pipeline/executor.py`, `scholarclaw_engine/config.py`
...
**文件**: `scholarclaw_engine/experiment/docker_sandbox.py`
