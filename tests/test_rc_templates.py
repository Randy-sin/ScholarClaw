"""Unit tests for scholarclaw_engine.templates — conference templates + MD→LaTeX converter."""

from __future__ import annotations

import pytest

from scholarclaw_engine.templates.conference import (
    CONFERENCE_REGISTRY,
    ConferenceTemplate,
    get_template,
    list_conferences,
...
class TestExportConfig:
    ...
    def test_default_values(self) -> None:
        from scholarclaw_engine.config import ExportConfig
    ...
    def test_rcconfig_has_export(self) -> None:
        ...
        cfg = RCConfig.load("config.scholarclaw.example.yaml", check_paths=False)
