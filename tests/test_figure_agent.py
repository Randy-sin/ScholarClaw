...
class TestStyleConfig:
    def test_constants_exist(self):
        from scholarclaw_engine.agents.figure_agent.style_config import (
...
class TestOrchestrator:
    ...
    def test_figure_plan_serialization(self):
        from scholarclaw_engine.agents.figure_agent.orchestrator import FigurePlan
        plan = FigurePlan(
...
class TestFigureAgentConfig:
    def test_default_config(self):
        from scholarclaw_engine.config import FigureAgentConfig
        cfg = FigureAgentConfig()
    ...
    def test_parse_from_dict(self):
        from scholarclaw_engine.config import _parse_figure_agent_config
...
class TestBackwardCompatibility:
    ...
    def test_figure_agent_importable(self):
        from scholarclaw_engine.agents.figure_agent import FigureOrchestrator, FigurePlan
