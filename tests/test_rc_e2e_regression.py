...
class TestRateLimitRetry:
    def test_s2_429_retries_and_succeeds(self) -> None:
        from scholarclaw_engine.literature.semantic_scholar import search_semantic_scholar
...
class TestDegradationChain:
    def test_search_degrades_to_cache_on_api_failure(self, tmp_path: Path) -> None:
        from scholarclaw_engine.literature.cache import put_cache
        ...
        with patch(
            ...
            with patch(
                ...
                with patch(
                    "scholarclaw_engine.literature.cache._DEFAULT_CACHE_DIR", tmp_path
                ):
        ...
        with patch(
            ...
            with patch(
                ...
                with patch(
                    ...
                    with patch(
                        "scholarclaw_engine.literature.cache._DEFAULT_CACHE_DIR",
...
class TestLLMFallback:
    def test_primary_403_forbidden_fallback_succeeds(self) -> None:
        from scholarclaw_engine.llm.client import LLMClient, LLMConfig, LLMResponse
...
class TestNoncriticalStageSkip:
    ...
    def test_noncritical_stage_failure_is_skipped(self, tmp_path: Path) -> None:
        ...
        from scholarclaw_engine.pipeline.stages import STAGE_SEQUENCE, Stage, StageStatus
