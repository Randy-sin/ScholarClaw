...
class TestVerifyByTitleSearch:
    ...
    def test_no_results_hallucinated(self) -> None:
        with patch("scholarclaw_engine.literature.search.search_papers", return_value=[]):
...
class TestVerifyCitations:
    def test_full_pipeline_mocked(self) -> None:
        ...
        with (
            patch("scholarclaw_engine.literature.verify.time.sleep"),
            patch("urllib.request.urlopen", side_effect=mock_urlopen),
            patch("scholarclaw_engine.literature.search.search_papers", return_value=[]),
        ):
