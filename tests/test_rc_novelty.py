"""Tests for scholarclaw_engine.literature.novelty — novelty detection module."""
...
from scholarclaw_engine.literature.novelty import (
    _assess_novelty,
...
class TestCheckNovelty:
    ...
    @patch("scholarclaw_engine.literature.search.search_papers_multi_query")
...
class TestHypothesisGenNoveltyIntegration:
    ...
    def test_novelty_report_written_when_available(self, tmp_path: Path) -> None:
        ...
        with patch(
            "scholarclaw_engine.literature.search.search_papers_multi_query"
        ) as mock_search:
            mock_search.return_value = []
    ...
    def test_novelty_failure_does_not_block(self, tmp_path: Path) -> None:
        ...
        with patch(
            "scholarclaw_engine.literature.novelty.check_novelty",
