...
class TestDockerRenderer:
    def _agent(self):
        ...
        return RendererAgent(
            ...
            timeout_sec=10,
            use_docker=True,
            docker_image="scholarclaw_engine/experiment:latest",
        )
...
class TestLatexDisplayMath:
    ...
    def test_dollar_dollar_to_equation(self):
        ...
        from scholarclaw_engine.templates.converter import _convert_block
    ...
    def test_inline_dollar_dollar_not_escaped(self):
        ...
        from scholarclaw_engine.templates.converter import _convert_inline
...
class TestLatexFigurePlacement:
    ...
    def test_figure_uses_top_placement(self):
        from scholarclaw_engine.templates.converter import _render_figure
...
class TestChatWithPromptStripThinking:
    ...
    def test_default_strips_thinking(self):
        ...
        from scholarclaw_engine.pipeline.executor import _chat_with_prompt
