...
from scholarclaw_engine.experiment.colab_sandbox import (
    ColabDriveSandbox,
...
class TestSshSandboxRun:
    ...
    def test_run_success(self, tmp_path: Path):
        ...
        def fake_ssh_run(command, *, timeout_sec=60):
            from scholarclaw_engine.experiment.ssh_sandbox import _SshResult
...
class TestAcpTimeoutFix:
    def test_timeout_passed_from_config(self):
        from scholarclaw_engine.config import RCConfig, AcpConfig, LlmConfig
    ...
    def test_timeout_default(self):
        from scholarclaw_engine.llm.acp_client import ACPClient
