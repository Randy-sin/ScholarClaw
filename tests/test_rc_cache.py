...
cache_mod = importlib.import_module("scholarclaw_engine.literature.cache")
...
class TestSearchDegradation:
            ...
            with patch(
                ...
                with patch(
                    ...
                    with patch(
                        ...
                        with patch(
                            "scholarclaw_engine.literature.search.time.sleep", lambda _: None
                        ):
    ...
    def test_search_caches_successful_results(self, tmp_path):
        ...
        with patch(
            ...
            with patch("scholarclaw_engine.literature.search.search_arxiv", return_value=[]):
                with patch(
                    "scholarclaw_engine.literature.cache._DEFAULT_CACHE_DIR", tmp_path
                ):
                    with patch(
