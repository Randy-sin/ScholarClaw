...
"""Unit tests for scholarclaw_engine.literature module.
...
from scholarclaw_engine.literature.semantic_scholar import (
    _parse_s2_paper,
    search_semantic_scholar,
)
from scholarclaw_engine.literature.arxiv_client import (
    _parse_atom_feed,
    search_arxiv,
)
...
class TestSemanticScholar:
    ...
    def test_search_semantic_scholar_mock(
        ...
        from scholarclaw_engine.literature.semantic_scholar import _reset_circuit_breaker
        ...
        monkeypatch.setattr(
            "scholarclaw_engine.literature.semantic_scholar.urllib.request.urlopen",
    ...
    def test_search_semantic_scholar_network_error(
        ...
        monkeypatch.setattr(
            "scholarclaw_engine.literature.semantic_scholar.time.sleep", lambda _: None
        )
...
class TestArxiv:
    ...
    def test_search_arxiv_mock(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        monkeypatch.setattr(
            "scholarclaw_engine.literature.arxiv_client.urllib.request.urlopen",
            lambda *a, **kw: mock_resp,
        )
...
class TestSearchPapers:
    def test_search_papers_combines_sources(
        ...
        monkeypatch.setattr(
            "scholarclaw_engine.literature.search.search_semantic_scholar",
            lambda *a, **kw: [s2_paper],
        )
        monkeypatch.setattr(
            "scholarclaw_engine.literature.search.search_arxiv",
            lambda *a, **kw: [arxiv_paper],
        )
        monkeypatch.setattr("scholarclaw_engine.literature.search.time.sleep", lambda _: None)
    ...
    def test_default_sources_openalex_first(self) -> None:
        ...
        from scholarclaw_engine.literature.search import _DEFAULT_SOURCES
    ...
    def test_s2_failure_does_not_block_others(
        ...
        monkeypatch.setattr(
            "scholarclaw_engine.literature.search.search_openalex",
            lambda *a, **kw: [],
        )
        monkeypatch.setattr(
            "scholarclaw_engine.literature.search.search_semantic_scholar",
    ...
    def test_search_papers_multi_query(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        monkeypatch.setattr(
            "scholarclaw_engine.literature.search.search_papers",
            mock_search,
        )
        monkeypatch.setattr("scholarclaw_engine.literature.search.time.sleep", lambda _: None)
...
class TestArxivCircuitBreaker:
    def setup_method(self) -> None:
        from scholarclaw_engine.literature.arxiv_client import _reset_circuit_breaker
        _reset_circuit_breaker()
    ...
    def test_429_triggers_circuit_breaker(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        from scholarclaw_engine.literature import arxiv_client
        _call_count = 0
        ...
        monkeypatch.setattr("scholarclaw_engine.literature.arxiv_client.time.sleep", lambda _: None)
    ...
    def test_retry_after_header_respected(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        monkeypatch.setattr(
            "scholarclaw_engine.literature.arxiv_client.time.sleep", _mock_sleep,
        )
...
class TestOpenAlex:
    def test_parse_openalex_response(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        from scholarclaw_engine.literature.openalex_client import search_openalex
        ...
        monkeypatch.setattr(
            "scholarclaw_engine.literature.openalex_client.urllib.request.urlopen",
            lambda *a, **kw: mock_resp,
        )
    ...
    def test_abstract_reconstruction(self) -> None:
        from scholarclaw_engine.literature.openalex_client import _reconstruct_abstract
    ...
    def test_openalex_network_error(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        monkeypatch.setattr(
            "scholarclaw_engine.literature.openalex_client.time.sleep", lambda _: None,
        )
...
class TestCacheTTL:
    def test_source_specific_ttl(self, tmp_path: Any) -> None:
        ...
        from scholarclaw_engine.literature.cache import get_cached, put_cache, _SOURCE_TTL
    ...
    def test_citation_verify_ttl_is_permanent(self) -> None:
        from scholarclaw_engine.literature.cache import _SOURCE_TTL
