...
class TestBenchmarkKnowledge:
    ...
    def test_knowledge_file_exists(self) -> None:
        from scholarclaw_engine.agents.benchmark_agent.surveyor import _KNOWLEDGE_PATH
...
class TestSurveyor:
    ...
    def test_domain_matching_image_classification(self) -> None:
        from scholarclaw_engine.agents.benchmark_agent.surveyor import SurveyorAgent
...
class TestSelector:
    ...
    def test_filter_excludes_tier3(self, benchmarks: list[dict]) -> None:
        from scholarclaw_engine.agents.benchmark_agent.selector import SelectorAgent
...
class TestAcquirer:
    ...
    def test_generate_setup_script_tier1_only(self) -> None:
        from scholarclaw_engine.agents.benchmark_agent.acquirer import AcquirerAgent
...
class TestValidator:
    ...
    def test_syntax_check_valid(self) -> None:
        from scholarclaw_engine.agents.benchmark_agent.validator import ValidatorAgent
...
class TestConfig:
    ...
    def test_default_config_has_benchmark_agent(self) -> None:
        from scholarclaw_engine.config import ExperimentConfig
    ...
    def test_parse_benchmark_agent_config(self) -> None:
        from scholarclaw_engine.config import _parse_benchmark_agent_config
...
class TestBaseAgent:
    ...
    def test_parse_json_direct(self) -> None:
        from scholarclaw_engine.agents.base import BaseAgent
